...
import com.makes360.android.BaseActivity
import com.makes360.android.R
import com.makes360.android.databinding.ActivityInternLoginBinding
...
class InternLogin : BaseActivity() {
    ...
    private fun navigateToInternTrack() {
        ...
        val intent = Intent(this, InternTrack::class.java)
...
//        }
        ...
        if (intent.resolveActivity(packageManager) != null) {
            ...
            Toast.makeText(this, "No application available to open the URL", Toast.LENGTH_SHORT)
                .show()
        }
    }
            ...
            Response.Listener { response ->
                ...
                try {
                    ...
                    if (jsonResponse.optBoolean("success", false)) {
                        ...
                        startActivity(
                            Intent(this, InternTrack::class.java).putExtra(
                                "EMAIL",
                                email
                            )
                        )
