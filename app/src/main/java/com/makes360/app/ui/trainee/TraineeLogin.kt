...
class TraineeLogin : BaseActivity() {
    ...
    private lateinit var mBinding: ActivityTraineeLoginBinding
    ...
    private fun loadContent() {
        ...
        if (isLoggedIn()) {
            navigateToTraineeDashboard()
            return
        }

        // Initialize binding
        mBinding = ActivityTraineeLoginBinding.inflate(layoutInflater)
    ...
    private fun saveLoginState(email: String) {
        ...
        editor.putString("trainee_email", email)
        editor.apply()
    }
    ...
    private fun isLoggedIn(): Boolean {
        val sharedPreferences = getSharedPreferences("TraineeLoginPrefs", MODE_PRIVATE)
        return sharedPreferences.getString("trainee_email", null) != null
    }

    // Utility function to navigate to InternTrack activity
    private fun navigateToTraineeDashboard() {
        val email = getSharedPreferences("TraineeLoginPrefs", MODE_PRIVATE)
            .getString("trainee_email", null)
    ...
    private fun sendOtp() {
        ...
        val url = "https://www.makes360.com/application/makes360/trainee/send-otp.php"
    ...
    private fun verifyOtp() {
        ...
        val url = "https://www.makes360.com/application/makes360/trainee/verify-otp.php"
        val requestQueue: RequestQueue = Volley.newRequestQueue(this)
            ...
            Response.Listener { response ->
                ...
                try {
                    ...
                    if (jsonResponse.optBoolean("success", false)) {
                        ...
                        startActivity(
                            Intent(this, TraineeDashboard::class.java).putExtra(
                                "EMAIL",
                                email
                            )
                        )
